const HeroSection = () => {
  return (
    <section className="hero-gradient text-white py-20 lg:py-32 relative overflow-hidden">
      ...
      <div className="absolute right-0 top-0 h-full w-1/2 z-10 hidden md:block">
      ...
      <div className="container mx-auto px-4 md:px-6 relative z-20">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="text-left">
            <h1 className="text-center md:text-left text-3xl md:text-4xl lg:text-5xl font-bold mb-6 leading-tight">
              Connect with Research Experts Worldwide
            </h1>
            <p className="text-center md:text-left text-lg mb-8 text-blue-100 leading-relaxed">
