...
const mockJobRequests: JobRequest[] = [
  {
    ...
    description: "I need help cleaning my survey data collected from 500 respondents. The data includes demographic information and mobility patterns.",
    filesAttached: 3,
  ...
  },
  {
    ...
    description: "Looking for comprehensive editing of my thesis chapter focusing on grammar, structure, and APA formatting.",
    filesAttached: 1,
  ...
  },
  {
    ...
    description: "Need assistance creating detailed maps showing land use changes over the past decade.",
    filesAttached: 5,
...
const ResearchAidsJobRequests = () => {
  ...
  const handleDeclineJob = (jobId: string) => {
    ...
    // Implementation for declining job
  };
