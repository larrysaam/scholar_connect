...
export const testCustomEmail = async (email: string, userName: string) => {
  try {
    const result = await emailNotificationService.sendCustomEmail({
      ...
      content: `
        <p>Thank you for joining ResearchWhoa! We're excited to have you as part of our academic community.</p>
...
export const EmailTestComponent = () => {
  ...
  const handleTestEmail = async () => {
    ...
    const result = await sendCustomEmail({
      ...
      content: 'This is a test email sent from the ResearchWhoa platform.',
      actionUrl: '/dashboard',
