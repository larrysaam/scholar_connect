    ...
    <section className="py-16 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="max-w-6xl mx-auto">
          <h2 className="text-3xl font-bold text-center mb-12">Why Choose ResearchWow Research Aids?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <Card className="text-center border-primary/20 hover:shadow-lg transition-shadow">
              <CardContent className="p-8">
                ...
                <p className="text-gray-600">Chat, share files, and manage tasks directly on ResearchWow's secure platform.</p>
              </CardContent>
            </Card>
          </div>
        </div>
