          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="max-w-4xl mx-auto">
              ...
              <p className="text-lg text-gray-700 mb-8">
                ScholarConnect is a revolutionary platform designed to bridge the gap between students, researchers, and academic experts across Africa and beyond. We facilitate meaningful collaborations that drive research excellence and academic success.
              </p>
              ...
              <p className="text-lg text-gray-700 mb-12">
                ScholarConnect provides a comprehensive platform where students can connect with experienced researchers and research aids for guidance, collaboration, and support throughout their academic journey. From research ideation to publication, we're here to help.
              </p>
