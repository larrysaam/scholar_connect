...
import { useAidQualityFeedback } from "@/hooks/useAidQualityFeedback";

const AidQualityAssuranceAndFeedbackTab = () => {
  const { platformMetrics, feedbackCategories, recentImprovements, positiveFeedback, negativeFeedback, loading, error } = useAidQualityFeedback();
  ...
  return (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <h2 className="text-2xl font-bold">Aid Platform Quality & Feedback</h2>
...
export default AidQualityAssuranceAndFeedbackTab;
