...
const AideSignUp = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setIsLoading(true);
    const result = await signUp(email, formData.password, { fullName: formData.fullName, role: 'aid' });
    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-2xl">
        ...
        <div className="bg-white rounded-lg shadow p-8">
          ...
          <form className="space-y-4" onSubmit={handleSubmit} autoComplete="off" aria-label="Research Aide Sign Up">
            <div>
            ...
            <div>
              ...
              <Input value={formData.fieldsOfExpertise} onChange={e => handleInputChange("fieldsOfExpertise", e.target.value)} required />
            </div>
            <div>
            ...
            <div className="flex items-center gap-2">
              <input 
                ...
                aria-required="true"
              />
              <Label htmlFor="terms-aide">I agree to the Terms of Service and Privacy Policy*</Label>
            </div>
            <Button type="submit" className="w-full mt-2" disabled={isLoading || !formData.agreedToTerms} aria-busy={isLoading}>
              {isLoading ? <LoadingSpinner size="sm" /> : "Create My Research Aid Account"}
            </Button>
